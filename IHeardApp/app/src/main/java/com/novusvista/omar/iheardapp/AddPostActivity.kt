...
class AddPostActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        close_add_post_btn.setOnClickListener{
            intent=Intent(this@AddPostActivity,SignInActivity::class.java)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?)
    {
        ...
        {
            Toast.makeText(this,"Error didn't select a image try again ",Toast.LENGTH_LONG).show()
    ...
    private fun uploadImage() {
        ...
        when {
            ...
            TextUtils.isEmpty(description_post.text.toString()) -> Toast.makeText(
                ...
                progressDialog.setMessage("Please wait, we are adding your image post...")
                progressDialog.show()
