...
import com.novusvista.omar.iheardapp.Adapter.CommentAdapter
...
class CommentsActivity : AppCompatActivity()
{
    ...
    private var commentList: MutableList<com.novusvista.omar.iheardapp.Model.Comment>? = null
        ...
        commentsRef.addValueEventListener(object : ValueEventListener
        {
            override fun onDataChange(p1: DataSnapshot)
            {
                if (p1.exists())
                {
                    ...
                    {
                        val comment = snapshot.getValue(com.novusvista.omar.iheardapp.Model.Comment::class.java)
